...
//  EssentialFeedTests
//
//  Created by rahul thengadi on 04/07/23.
//
...
class CodableFeedStoreTest: XCTestCase, FailableFeedStoreSpecs {
    ...
    func test_retrieve_deliversFailureOnRetrieveError() {
        ...
        assertThatRetrieveDeliversFailureOnRetrieveError(on: sut)
    }
...
//    func test_delete_deliversErrorOnDeletionError() {
//        let noDeletePermissionDirectoryURL = cachesDirectory()
//        let sut = makeSUT(storeURL: noDeletePermissionDirectoryURL)
//
